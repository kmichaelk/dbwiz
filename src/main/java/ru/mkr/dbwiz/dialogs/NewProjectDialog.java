...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        scrollPane1.setViewportView(modulesPanel);
        final JLabel label1 = new JLabel();
        label1.setText("Выберите необходимые модули:");
        modulesPanel.add(label1, BorderLayout.NORTH);
    }
